(ns clojure-experiment.conversation-tests
...
(defn conversation-fixture
  ...
  (ts/create-auth0-test-user
   {:connection "Username-Password-Authentication"
    :email "account-tests@clojure-experiment.app"
    :password "s#m3R4nd0m-pass"})
  (reset! ts/token (ts/get-test-token "account-tests@clojure-experiment.app"))
