(ns clojure-experiment.recipe-tests
  (:require [clojure.test :refer :all]
            [clojure-experiment.server :refer :all]
            [clojure-experiment.test-system :as ts]))

(defn recipe-fixture
  [f]
  (ts/create-auth0-test-user
   {:connection "Username-Password-Authentication"
    :email      "recipe-tests@clojure-experiment.app"
    :password   "s#m3R4nd0m-pass"})
  (reset! ts/token (ts/get-test-token "recipe-tests@clojure-experiment.app"))
